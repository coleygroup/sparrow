...
def create_buyables_from_sparrow(tree_file='examples/amd/trees_w_info.json'):
...
def create_buyable_from_trees(tree_folder='examples/amd/baselines/trees'): 
    buyables = {}
...
df.to_csv('examples/amd/baselines/price_comparison.csv')
