...
savedir = Path('examples/amd/baselines/trees')
...
for i, smi in enumerate(df['SMILES']): 
    ...
    print(f'{len(tree["Compound Nodes"])} compounds, {len(tree["Reaction Nodes"])} reactions, saved to {treefile}')
