""" 
Adapted from SynNet @ https://github.com/wenhao-gao/SynNet/tree/master 
Note: children in SynNet = reactants, parents = products (reverse in RouteSelector)
"""

from pathlib import Path
from typing import Union, Dict, List

from vis_utils import NodeChemical, NodeRxn, SyntheticTree
from drawers import MolDrawer
from writers import subgraph
...
def demo():
    ...
    infile = Path.cwd() / "synnet_visualizer" / "syntree-small.json"
    ...
    from drawers import MolDrawer
    from visualizer import SynTreeVisualizer
    from writers import SynTreeWriter

    outpath = Path.cwd() / "synnet_visualizer" / "images"
